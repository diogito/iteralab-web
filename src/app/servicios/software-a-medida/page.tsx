...
import { Code2, DollarSign, Key, Server, ArrowRight, CheckCircle } from 'lucide-react';
...
const benefits = [
  {
    icon: DollarSign,
    title: 'Sin Costos de Licencia Mensual',
    description: 'Un desarrollo, tuyo para siempre. Sin pagos recurrentes ni dependencia de terceros.',
  },
  {
    icon: Key,
    title: 'Propiedad Intelectual 100% Tuya',
    description: 'El código fuente es tuyo. Puedes modificarlo, ampliarlo o venderlo cuando quieras.',
  },
  {
    icon: Server,
    title: 'Arquitectura Escalable',
    description: 'Construido con Next.js y AWS para crecer sin límites técnicos ni reescrituras.',
  },
];
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
            <div className="text-center max-w-4xl mx-auto">
              ...
              >
                ...
                <span className="text-sm font-medium">Desarrollo Personalizado</span>
              </motion.div>
              ...
              >
                ...
                <span className="text-indigo-600 dark:text-indigo-400"> no al revés.</span>
              </motion.h1>
              ...
              >
                Deja de luchar contra limitaciones de SaaS genéricos. Construimos
                activos digitales de tu propiedad que escalan con tu negocio.
              </motion.p>
                ...
                <div className="p-8 rounded-2xl bg-red-500/5 border border-red-500/20">
                  ...
                  <ul className="space-y-3 text-zinc-600 dark:text-zinc-400">
                    <li className="flex items-start gap-3">
                      ...
                      SaaS genéricos que no se adaptan a tu flujo de trabajo
                    </li>
                    <li className="flex items-start gap-3">
                      <span className="text-red-400 mt-1">✕</span>
                      Pagos mensuales eternos que nunca terminan
                    </li>
                    <li className="flex items-start gap-3">
                      <span className="text-red-400 mt-1">✕</span>
                    ...
                    <li className="flex items-start gap-3">
                      <span className="text-red-400 mt-1">✕</span>
                      Limitaciones que frenan tu crecimiento
                    </li>
                  </ul>
                </div>
              </AnimatedSection>
                ...
                <div className="p-8 rounded-2xl bg-green-500/5 border border-green-500/20">
                  ...
                  <ul className="space-y-3 text-zinc-600 dark:text-zinc-400">
                    <li className="flex items-start gap-3">
                      ...
                      Software moldeado exactamente a tus procesos
                    </li>
                    <li className="flex items-start gap-3">
                      <CheckCircle className="w-5 h-5 text-green-600 dark:text-green-400 mt-0.5 flex-shrink-0" />
                      Una inversión, un activo permanente
                    </li>
                    <li className="flex items-start gap-3">
                      <CheckCircle className="w-5 h-5 text-green-600 dark:text-green-400 mt-0.5 flex-shrink-0" />
            ...
            <AnimatedSection>
              <div className="text-center mb-16">
                <h2 className="font-display text-3xl sm:text-4xl font-bold mb-4 text-zinc-900 dark:text-zinc-100">
                  Ventajas <span className="text-indigo-600 dark:text-indigo-400">Competitivas</span>
                </h2>
                <p className="text-zinc-600 dark:text-zinc-400 max-w-2xl mx-auto">
                  Tu software, tus reglas. Sin restricciones artificiales ni costos ocultos.
                </p>
              </div>
            </AnimatedSection>
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <AnimatedSection>
              ...
              <p className="text-zinc-600 dark:text-zinc-400 text-lg mb-8">
                Conversemos sobre tu proyecto. Te entregamos una propuesta técnica y económica sin compromiso.
              </p>
