        ...
        <section className="relative min-h-[80vh] flex items-center pt-16 overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
            <div className="text-center max-w-4xl mx-auto">
              ...
              >
                Tu CTO On-Demand.
                <span className="text-indigo-600 dark:text-indigo-400"> Ingeniería sin Riesgos.</span>
              </motion.h1>
            ...
            <AnimatedSection>
              <div className="text-center mb-16">
                <h2 className="font-display text-3xl sm:text-4xl font-bold mb-4 text-zinc-900 dark:text-zinc-100">
                  Servicios de <span className="text-indigo-600 dark:text-indigo-400">Consultoría</span>
                </h2>
