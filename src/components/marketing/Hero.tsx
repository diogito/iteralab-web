...
export function Hero() {
  return (
    <section className="relative min-h-screen flex items-center pt-16 overflow-hidden" id="inicio">
      ...
      <div className="absolute top-1/3 left-1/4 w-[600px] h-[400px] bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-indigo-500/10 dark:from-indigo-500/20 via-transparent to-transparent blur-3xl pointer-events-none" />
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            >
              ...
              <span className="text-indigo-600 dark:text-indigo-400"> merece.</span>
            </motion.h1>
            ...
            <motion.p
              ...
              className="mt-6 text-lg sm:text-xl text-zinc-600 dark:text-zinc-400 max-w-xl"
            >
            ...
            >
              <div className="flex items-center gap-2">
                <svg className="w-5 h-5 text-indigo-600 dark:text-indigo-500" fill="currentColor" viewBox="0 0 20 20">
          ...
          <AnimatedSection delay={0.2} className="hidden lg:block">
            <div className="relative">
              {/* Main card */}
              <div className="relative bg-gradient-to-br from-white to-zinc-100 dark:from-zinc-900 dark:to-zinc-800 rounded-2xl p-8 border border-zinc-200 dark:border-zinc-700/50 shadow-2xl shadow-zinc-300/50 dark:shadow-none">
                {/* Browser dots */}
                ...
                <div className="space-y-3 font-mono text-sm">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-zinc-700 dark:text-zinc-300">performance</span>
                    <span className="text-zinc-500">=</span>
                    <span className="text-green-600 dark:text-green-400">&apos;100/100&apos;</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <span className="text-indigo-600 dark:text-indigo-400">const</span>
                  ...
                  <div className="flex items-center gap-2">
                    <span className="text-indigo-600 dark:text-indigo-400">const</span>
                    <span className="text-zinc-700 dark:text-zinc-300">uptime</span>
                    <span className="text-zinc-500">=</span>
                    <span className="text-green-600 dark:text-green-400">&apos;99.99%&apos;</span>
                  </div>
                </div>
